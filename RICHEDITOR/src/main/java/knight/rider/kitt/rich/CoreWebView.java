...
class CoreWebView extends WebView {
    ...
    private static final String SETUP_HTML = "file:///android_asset/no_editor.html";
    ...
    /**
     * {@link knight.rider.kitt.rich.CoreWebView#insertImage(String, String)} will show the original size of the image.
